...
public abstract class UnoGestureDetector extends GestureDetector {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		boolean isPointInView = _target.isMotionInView(_target.getTransformedTouchX(), _target.getTransformedTouchY());
	...
	protected UnoGestureDetector(android.content.Context context, final UnoViewGroup target)
	{
		super(context, new OnGestureListener() {
			...
			public boolean onDown(MotionEvent e) {
				...
				boolean isPointInView = target.isMotionInView(target.getTransformedTouchX(), target.getTransformedTouchY());
