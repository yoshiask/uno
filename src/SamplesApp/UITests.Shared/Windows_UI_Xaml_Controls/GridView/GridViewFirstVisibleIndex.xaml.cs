...
{
	[SampleControlInfoAttribute("GridView", nameof(GridViewFirstVisibleIndex), typeof(ViewModelBase), description: "GridView with FirstVisibleIndex and LastVisibleIndex shown")]
