...
{
	[SampleControlInfo("ListViewTests", nameof(ListView_Scrolling_Vertical_Automated))]
	public sealed partial class ListView_Scrolling_Vertical_Automated : UserControl
	{
		public ListView_Scrolling_Vertical_Automated()
		{
