...
{
	[SampleControlInfo("ListViewTests", nameof(ListView_GroupedItems_Selection_Automated))]
	public sealed partial class ListView_GroupedItems_Selection_Automated : UserControl
	{
		public ListView_GroupedItems_Selection_Automated()
		{
