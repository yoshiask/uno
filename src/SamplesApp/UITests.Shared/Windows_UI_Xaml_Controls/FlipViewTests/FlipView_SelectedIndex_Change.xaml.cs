...
{
	[SampleControlInfoAttribute("FlipView", nameof(FlipView_SelectedIndex_Change), description: "FlipView whose SelectedIndex can be changed by small or large increments.")]
