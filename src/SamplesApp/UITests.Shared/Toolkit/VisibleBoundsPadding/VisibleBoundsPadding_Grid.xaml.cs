...
{
	[SampleControlInfo("Toolkit", nameof(VisibleBoundsPadding_Grid))]
	public sealed partial class VisibleBoundsPadding_Grid : UserControl
	{
		public VisibleBoundsPadding_Grid()
		{
