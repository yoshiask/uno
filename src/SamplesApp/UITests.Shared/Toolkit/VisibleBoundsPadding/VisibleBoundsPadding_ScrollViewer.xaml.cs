...
{
	[SampleControlInfo("Toolkit", nameof(VisibleBoundsPadding_ScrollViewer))]
	public sealed partial class VisibleBoundsPadding_ScrollViewer : UserControl
	{
		public VisibleBoundsPadding_ScrollViewer()
		{
