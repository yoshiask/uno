...
{
	[SampleControlInfo("Toolkit", nameof(VisibleBoundsPadding_Border))]
	public sealed partial class VisibleBoundsPadding_Border : UserControl
	{
		public VisibleBoundsPadding_Border()
		{
